...
public class CrearObjetoCommandTests
{
    ...
    {
        var cmd = new CrearObjetoCommand(Guid.NewGuid(), "abc", "desc corta", 1, "Nuevo", 1, 1, 1, new List<string> { "u" });
    ...
    public async Task Handler_Throws_NotFound_When_Usuario_Missing()
    {
        ...
        var usuariosRepo = new Mock<IUsuarioRepository>();
        ...
        var cmd = new CrearObjetoCommand(Guid.NewGuid(), "Titulo valido", new string('x', 30), 1, "Nuevo", 1, 1, 1, new List<string> { "url" });
    ...
    public async Task Handler_Crea_Objeto_Y_Agrega_Imagenes()
    {
        ...
        var objetosRepo = new Mock<IObjetoRepository>();
        ...
        var cmd = new CrearObjetoCommand(usuarioId, "Titulo valido", new string('x', 30), 1, "Nuevo", 1, 1, 1, new List<string> { "u1", "u2" });
